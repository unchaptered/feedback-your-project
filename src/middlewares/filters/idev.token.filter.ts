...
@provide(FILTERS.IDevForToken)
export class IDevForTokenFilter extends BaseMiddleware {
    ...
    public async handler(
        ...
        const iDev: IDevForToken | Error = await this.joiProvider.validateIDevForToken(req?.body);
